...
export default function About() {
  return (
    <section id="about" className="py-20 md:py-28 bg-gray-50 dark:bg-gray-800/50">
      <div className="container mx-auto px-4 sm:px-6">
              ...
              <div className="grid md:grid-cols-2 gap-8 md:gap-12">
                <div className="space-y-4">
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    Associate Software Engineer at <span className="font-semibold text-gray-900 dark:text-white">Ebitaus, Chennai</span>, 
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    Achieved <span className="font-semibold text-gray-900 dark:text-white">99.9% availability</span> across 
                    client-facing platforms and successfully cleared <span className="font-semibold text-gray-900 dark:text-white">VAPT compliance</span> assessments. 
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    Serving as <span className="font-semibold text-gray-900 dark:text-white">Project Owner</span> for 
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    Optimized backend performance by <span className="font-semibold text-gray-900 dark:text-white">30%</span> through 
                    clean coding practices, effective database design, and efficient Spring Boot implementation. 
                    Reduced deployment time by <span className="font-semibold text-gray-900 dark:text-white">40%</span> using modern DevOps workflows.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white text-center mb-12">Core Competencies</h3>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 animate-slideUp" style={{ animationDelay: '0.2s' }}>
            <Card className="group border border-gray-200 dark:border-gray-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
          ...
          <Card className="border-2 border-blue-100 dark:border-blue-900/30 bg-gradient-to-br from-blue-50/50 to-white dark:from-blue-950/20 dark:to-gray-900">
            <CardContent className="p-8 md:p-10 text-center space-y-4">
              ...
              <div className="flex flex-wrap justify-center gap-3 pt-4">
                <span className="px-4 py-2 rounded-lg bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700">Spring Boot</span>
                <span className="px-4 py-2 rounded-lg bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700">MongoDB</span>
                <span className="px-4 py-2 rounded-lg bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700">AWS</span>
                <span className="px-4 py-2 rounded-lg bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700">REST APIs</span>
                <span className="px-4 py-2 rounded-lg bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700">DevOps</span>
                <span className="px-4 py-2 rounded-lg bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700">VAPT</span>
              </div>
            </CardContent>
          </Card>
        </div>
